...
import { CarAgentAdapter, Message } from "./adapter";
...
describe("DefaultCarAgentAdapter", () => {
	let mockPrivateKey: PrivateKey;
	let mockPublicKey: PublicKey;
	let mockSigner: DaiaOfferSigner;
	let config: CarAgentConfig;
	let adapter: DefaultCarAgentAdapter;
	...
	beforeEach(() => {
		...
		adapter = new DefaultCarAgentAdapter(config);
	...
	describe("interface compliance", () => {
		it("should not expose LLM-specific configuration through public interface", () => {
			...
			const adapterAsInterface: CarAgentAdapter = adapter;
