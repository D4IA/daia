 ...
 *
 * Recommended faucet: https://scrypt.io/faucet/ or https://witnessonchain.com/faucet/tbsv
 */
function generateKeys(): void {
	...
	console.log("   https://scrypt.io/faucet/ or https://witnessonchain.com/faucet/tbsv");
