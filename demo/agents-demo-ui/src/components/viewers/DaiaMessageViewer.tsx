	...
	switch (message.type) {
				...
				<div className="bg-base-300 rounded-lg p-4 space-y-2 text-base-content">
					...
					<div className="text-sm space-y-2">
						...
						{innerContent?.requirements &&
							Object.keys(innerContent.requirements).length >
								0 && (
								<div>
									<span className="font-semibold opacity-80">
										Requirements:
		...
		case DaiaMessageType.OFFER_RESPONSE:
			if (message.result === "accept") {
				let innerContent
				try {
					innerContent = JSON.parse(
						message.agreement.offerContent.inner,
					)
				} catch {
					innerContent = null
				}
				...
				return (
					<div className="bg-base-300 rounded-lg p-4 space-y-2 text-base-content">
						...
						<div className="text-sm space-y-2">
							...
							{message.agreement.proofs &&
								Object.keys(message.agreement.proofs).length >
									0 && (
									<div>
										<span className="font-semibold opacity-80">
											Proofs:
