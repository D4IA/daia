import { CarGateSimulationEnvironment, CarGateSimulationEnvironmentConfig } from "@d4ia/agents-demos"
import { ReactNode, useMemo, useState, useCallback } from "react"
import { ParkingSimulationContext, ParkingSimulationContextData, ParkingSimulationDisplayData, CarConfig } from "./ParkingSimulationContext"

export const ParkingSimulationContextProvider = (
    props: {
    ...
    return (<ParkingSimulationContext.Provider value={data}>
        {props.children}
